...
\makeAbbreviationToRecord{motionForReconsideration}{Motion for Reconsideration}{Motion for Reconsideration, filed by Appellant/Petitioner with Tax Tribunal on 12/10/2019}
...
\subsection{The second hearing before the Tax Tribunal}
...
\subsection{The Tax Tribunal misinterpreted \mathieuGast\ when it ruled that normal repairs may be ignored if there is some evidence that the assessor did not need to consider repairs to justify the assessed value}
