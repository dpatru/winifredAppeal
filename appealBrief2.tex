...
\noindent III. Did the Tribunal err when it gave the selling price of the property before-repair ``no weight or credibility'' based solely on the fact that the seller was a government entity and speculation that the seller may not have been motivated to receive market value?
...
1) it believed that the STC's requirement of a before-repair appraisal was not binding
and
...
The second sentence of the statute does not excuse the assessor from performing a before-repair assessment to aid in obeying the first and third sentences of the statute. Thus the Tribunal's reference to the second sentence is irrelevant. 
...
The Tribunal's third and final reason for departing from STC guidelines and refusing the requirement of a before-repair appraisal is that ``STC guidance lacks the force of law. [citing \pincite{Rovas}{103; 267}].'' \reconsiderationDenied[2].
...
\subsubsection{Failure of petitioner's proofs did not excuse the Tribunal from independently determining the true cash value}
...
\subsection{The Tribunal erred when it gave the selling price of the property ``no weight or credibility'' based solely on the fact that the seller was a government entity and speculation that the seller may not have been motivated to receive market value}
