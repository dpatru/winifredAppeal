...
citecase patru done\par%
\caseReference{Patru}{patruvwayne}% 
case reference done\par%
patru reference (\Call{Patru@Reference})\par%
patru referencep (\Call{Patru@ReferenceP}[4])\par%
long citation (\bbCaseLongCitations{Patru}{})\par
long citation p4 (\bbCaseLongCitations{Patru}{4})\par

long citation (\bbCaseLongCitations{Patru}{})\par
long citation p4 (\bbCaseLongCitations{Patru}{4})\par
case index citations (\Call{Patru@CaseIndexCitations})\par
