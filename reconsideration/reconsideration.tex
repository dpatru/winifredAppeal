...
\end{quote}
Opinion at 5. Regarding the tribunal's use of the photographs:%using photographs to show that the repairs did not affect the value of the house.
...
Instead, despite finding that the repairs were normal, the tribunal did not apply nonconsideration because of the second reason: the transfer of ownership and uncapping created an exception. Opinion at 5. %The teaching of \cite[s]{Bennett}\ is helpful here.
