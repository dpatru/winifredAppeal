...
Appellant objected to this in Exceptions and a Motion for Reconsideration, but the Tribunal's Judge affirmed.

Appellant appealed for the first time to the Court of Appeals.

\subsection{The First Appeal to the Court of Appeals}

In an unpublished decision, the Court of Appeals Court reversed:
...
The Court noted that Appellant ``submitted a spreadsheet detailing the repairs he completed, which . . . included repairs that, under \mathieuGast, constitute normal repairs.'' \pincite{Patru 1}{4}.
...
\section{Grounds for Granting the Application}
...
\section{Argument in Support of Appellant's Position on the Issues}
...
\subsection{If the Tribunal finds that normal repairs were made, it must determine the before-repair value.}
