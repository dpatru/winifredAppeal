...
Appellant filed \cite{Exceptions}, pointing out that the statute did not depend on the house's condition. Attached with the Exceptions, Appellant submitted a spreadsheet showing that statutory category of each repair.
...
Appellant appealed to the Court of Appeals, which reversed. \cite{Patru 1}. The Court agreed with the Tribunal that the referee had erred.
...
On remand, the Tribunal ruled that the repairs were normal repairs but found other reasons why
``Petitioner's property assessment did not change by virtue of the repairs Petitioner made to the subject property.'' \pincite{FOJ 2}{5}.

\begin{enumerate}
  
\item The property's assessment for 2016 changed based on the sale
  transaction in August 2015 and not based on Petitioner's
  repairs. \pincite{FOJ 2}{5}.
\item The assessment considered the property in average condition as it was on December 31, 2015, tax day. \pincite{FOJ 2}{5}.
\item The MLS photographs show that the property  was in average condition, not neglected or vandalized. \pincite{FOJ 2}{5}.
\item The property's sale was not an ``arm's length transaction'' because Petitioner had not claimed it so and because the seller was HUD. \pincite{FOJ 2}{6}.
\end{enumerate}

Appellant responded to each of these reasons in a \cite{Tribunal Motion Reconsider 2}. The Tribunal denied the motion, shifting the reason for rejecting application of the statute.


\begin{enumerate}
\item The Tribunal acknowledged that ``the plain language of MCL 211.27(2) prevents an assessor from increasing the true cash value of
  a property `that is a result of expenditures for normal repairs,' and does not speak to
  whether a property has been uncapped.'' \pincite{Tribunal's Denial of Reconsideration 2}. Nevertheless the Tribunal concluded that ``the
  FOJ did not commit palpable error in its final conclusion.''

was not based on Petitioner's `normal' repairs to the subject property.'' \pincite{Tribunal's Denial of Reconsideration 2}{1}. 
, not based on the normality of the repairs, to refuse to apply the statute. The Tribunal's Final Opinion and Judgment listed four reasons why
...
``Respondent's 2016 assessment was not based on Petitioner's `normal' repairs to the subject property.'' \pincite{Tribunal's Denial of Reconsideration 2}{1}. 
...
\pincite{Patru 2}{3}.% \pincite{Tribunal's Denial Reconsideration}{1-2}.
...
\item The Tribunal ruled that the sale price of the property was not good evidence of its value because the property was sold by \HUD, an entity whose ``motivation may not have been to receive market value for the property.'' \pincite{Tribunal's Denial of Reconsideration 2}{2}.
