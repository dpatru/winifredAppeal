...
The Court of Appeals erred in its analysis when it equated true cash value with fair market value ``regardless of any ``normal repairs'' made by petitioner in [the year of purchase].'' \pincite{Patru 2}{5}. \mathieuGast\ is part of the section (MCL 211.27) which  determines what true cash value. It explicitly excludes from the true cash value for assessment purposes the value added by normal repairs.
